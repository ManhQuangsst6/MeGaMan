...
public class GameWorld extends State {
    ...
    public GameWorld(GamePanel gamePanel){
        ...
        texts1[0] = "Để bảo vệ hòa bình thế giới ";
        texts1[1] = "  VÌ một ngày mai tươi sáng\n"
                + "Chúng tôi là những kẻ phản diện làm ngây ngất lòng người....";
        texts1[2] = "Kill'em all";
        texts1[3] = "      LET'S GO!.....";
        ...
        if(g2!=null){
            ...
            switch(state){
                ...
                case PAUSEGAME:
                    ...
                    BackgroundPause b=new BackgroundPause(g2);
                    g2.setColor(Color.BLACK);
            ...
            if(state==GAMEWIN||state==GAMEOVER ){
